    ...
    <div className="rounded-2xl border border-white/10 bg-white/5 p-5 shadow-lg">
      ...
      {!isOpen ? null : (
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          ...
          <div>
            <label htmlFor="reminderTime" className="block text-sm font-medium text-white/80">Reminder Time (Optional)</label>
            <input
              type="datetime-local"
              id="reminderTime"
              value={reminderTime}
              ...
              className="mt-1 w-full rounded-lg border border-white/10 bg-white/10 px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-400/40"
            />
            <p className="mt-1 text-xs text-white/50">You'll be notified at this time</p>
          </div>
