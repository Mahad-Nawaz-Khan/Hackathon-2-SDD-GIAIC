...
async def get_tasks(
    ...
    tags: Optional[str] = Query(None, description="Filter by tag IDs (comma-separated, AND logic)"),
    ...
    Query Parameters:
        ...
        tags: Comma-separated tag IDs for filtering (AND logic - task must have ALL tags)
